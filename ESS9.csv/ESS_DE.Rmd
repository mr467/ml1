...
The error for both types of neutral network model is still high, the optimization options were limited, as changing variables lead to high computing times. 
Nevertheless the models predict values for the two chosen variables. The continuous model lead to better results, comparing the calculated errors. 
