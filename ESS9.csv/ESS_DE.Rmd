...
```
The number of education years has a "edf" value of 1.9 this means it isn't linear but has the lowest value of the three parameter and the model can be refitted. 
