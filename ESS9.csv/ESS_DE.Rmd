...
The summary shows the residual deviance as 1532064 on 16960 degrees of freedom. This indicates a overdispersion as the difference between these two numbers is large.
...
2.  Predicting the values for the categorical variable indicating the 5 levels of
...
Look at the distribution of our different prediction classes in the train and test data sets. The data shows a concentration of 4 and 5 values. The participants of this survey are often and frequently using the internet.
