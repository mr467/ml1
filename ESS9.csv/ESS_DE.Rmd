...
The plot shows the media consumption for male and female to gain a quick overview. Males have a higher mean and the variance for the first and third quantile is larger as well.
...
The summary shows the residual deviance as 1532064 on 16960 degrees of freedom. This indicates an overdispersion as the difference between these two numbers is large.
...
Female do consume approx. 10% less media than male participants.
