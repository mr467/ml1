...
```{r}
# Setting NA values correct for the used parameters replace with na function from naniar package
...
#testing if change has worked and how many na we have - for three examples
...
ess9_poisson <- ess9_poisson %>% drop_na((c(nwspol,eduyrs, stfgov, stfdem, gndr, agea)))
