...
```{r}
lm_news.2 <- lm(nwspol.na ~ eduyrs.na + age.na + gndr.fac + stfdem.na + ability + polinteress, data = ess9_linear)
summary(lm_news.2)
```
...
```{r}
lm_news.3 <- lm(nwspol.na ~ eduyrs.na + age.na * polinteress + gndr.fac + stfdem.na + ability, data = ess9_linear)
summary(lm_news.3)
```
